...
const images = new Map([
    ["ghcr.io/immich-app/immich-server:release", `${registry_host}/ghcr.io/immich-app/immich-server:release`],
    ["ghcr.io/immich-app/immich-machine-learning:release", `${registry_host}/ghcr.io/immich-app/immich-machine-learning:release`]
])
